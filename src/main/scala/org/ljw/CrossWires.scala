...
case class U(d: Int) extends Direction
case class D(d: Int) extends Direction
case class R(d: Int) extends Direction
case class L(d: Int) extends Direction
...
object CrossWires {
  ...
  def getValues(s: String) : List[Direction] = {
